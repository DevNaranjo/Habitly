...
public class HabitlyLegalTest {
    ...
    public void testFiscalidadIGIC() {
        ...
        assertEquals(1000.0, p.getPrecioFinalConImpuestos(), 0.01);
        
        p.setEsAlquilerTuristico(true);
        assertEquals(1070.0, p.getPrecioFinalConImpuestos(), 0.01); // 7% IGIC
    }
    ...
    public void testValidacionIRAV() {
        ...
        ContratoAlquiler cIlegal = new ContratoAlquiler(casa.getDireccion(), "INQ_DNI", TipoArrendador.FISICO, 1600.0, 60, 'B');
    ...
    public void testCicloVidaAlquiler() {
        ...
        ContratoAlquiler contrato = new ContratoAlquiler(piso.getDireccion(), inq.getDni(), TipoArrendador.FISICO, 800.0, 60, 'B');
        String res = gestor.formalizarContrato(contrato, piso);
