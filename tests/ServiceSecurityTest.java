...
public class ServiceSecurityTest {
    ...
    public void testAuthorizationRestrictions() {
        ...
        assertFalse(viviendaService.registrarPiso("12345678Z", "Calle A", java.math.BigDecimal.valueOf(500), 50, 2, 1, false, false, false, "Buena", 1, "A", false));
        assertFalse(viviendaService.registrarGastoSuministro(null, "Luz", java.math.BigDecimal.valueOf(100)));
        ...
        assertTrue(viviendaService.registrarPiso("48484848L", "Calle Prop1", java.math.BigDecimal.valueOf(600), 60, 3, 2, true, false, true, "Excelente", 2, "B", false));
        ...
        assertFalse(viviendaService.actualizarPiso((Piso)piso1, "Calle Cambiada", java.math.BigDecimal.valueOf(700), 60, 3, 2, true, false, true, "Excelente", 2, "B", false));
